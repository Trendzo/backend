...
const PRODUCT_SPECS: ProductSpec[] = [
  // ═══ HER — Dresses (5) ═══
  { name: 'Silk Slip Dress', gender: 'her', cat: 'dresses', brand: 'zara', occ: ['party', 'date'], rating: '4.70', ratingCount: 412, gallery: [u('photo-1539109136881-3be0616acf4b')], colors: [{ name: 'Blush', hex: '#ffafbd', img: png('dress', 197), sizes: sz('XS,S,M,L'), priceRs: 2799, compareRs: 3999 }] },
  { name: 'Floral Maxi Dress', gender: 'her', cat: 'dresses', brand: 'hm', occ: ['brunch', 'beach'], rating: '4.80', ratingCount: 633, gallery: [u('photo-1496747611176-843222e1e57c')], colors: [{ name: 'Coral', hex: '#ff6b9d', img: png('dress', 196), sizes: sz('S,M,L,XL'), priceRs: 3299, compareRs: 4499 }] },
  { name: 'Elegant Mini Dress', gender: 'her', cat: 'dresses', brand: 'zara', occ: ['party', 'date'], rating: '4.50', ratingCount: 287, gallery: [u('photo-1483985988355-763728e1935b')], colors: [{ name: 'Champagne', hex: '#f5e6d3', img: png('dress', 194), sizes: sz('XS,S,M'), priceRs: 1799, compareRs: 2499 }] },
  { name: 'Satin Wrap Dress', gender: 'her', cat: 'dresses', brand: 'versace', occ: ['wedding', 'party'], rating: '4.90', ratingCount: 198, gallery: [u('photo-1469334031218-e382a71b716b')], colors: [{ name: 'Emerald', hex: '#10B981', img: png('dress', 197), sizes: sz('S,M,L'), priceRs: 6999, compareRs: 9499 }] },
  { name: 'Pleated Midi Dress', gender: 'her', cat: 'dresses', brand: 'uniqlo', occ: ['brunch'], rating: '4.40', ratingCount: 351, gallery: [u('photo-1485518882345-15568b007407')], colors: [{ name: 'Sage', hex: '#a8e6cf', img: png('dress', 196), sizes: sz('S,M,L,XL'), priceRs: 2199, compareRs: 2999 }] },
